...
AddEventHandler('esx_lscustom:buyMod', function(price)
	...
	if Config.IsMechanicJobOnly then
		...
		TriggerEvent('esx_addonaccount:getSharedAccount', 'society_tunners', function(account)
...
ESX.RegisterServerCallback('esx_lscustom:getVehiclesPricesImported', function(source, cb)
	if not Vehicles then
